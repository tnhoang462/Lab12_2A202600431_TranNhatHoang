...
def metrics(_key: str = Depends(verify_api_key)):
    ...
    return {
        ...
        "daily_cost_usd": round(cost_guard._global_cost, 4),
        "daily_budget_usd": settings.daily_budget_usd,
        "budget_used_pct": round(cost_guard._global_cost / settings.daily_budget_usd * 100, 1)
        if settings.daily_budget_usd > 0 else 0,
    }
